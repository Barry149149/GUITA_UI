export const resultSample={
    ...
    "breakdown": [
        ...
        },
        {
            ...
            "result": {
                "candidates": "[Button@2b768f4b[styleClass=button big-button]'Return', Text[text=\"Return\", x=0.0, y=0.0, alignment=LEFT, origin=BASELINE, boundsType=LOGICAL_VERTICAL_CENTER, font=Font[name=System Regular, family=System, style=Regular, size=15.0], fontSmoothingType=LCD, fill=0x333333ff]]",
        ...
        },
        {
            ...
            "result": {
                "candidates": "[Button@638b23bb[styleClass=button big-button]'Choose map directory', Text[text=\"Choose map directory\", x=0.0, y=0.0, alignment=LEFT, origin=BASELINE, boundsType=LOGICAL_VERTICAL_CENTER, font=Font[name=System Regular, family=System, style=Regular, size=15.0], fontSmoothingType=LCD, fill=0x333333ff]]",
                "position": "[144.0, 93.0]",
        ...
        },
        {
            ...
            "errors": [
                {
                    "message": "GuitaDriverError: Caught stderr originated from driver DOM ",
